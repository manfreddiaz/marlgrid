import numpy as np
from marlgrid.envs.captureflag import CapturingFlagEnv
...
# Start an episode!
# Each observation from the environment contains a list of observations for each agent.
...
while not done:
    ...
    agent_actions = list(env.action_space.sample())
    agent_actions[0] = player_action
